...
public class ThisOrThatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("This or That");
        setContentView(R.layout.activity_thisorthat);
    ...
    public ArrayList<String> readFile() {
        ...
        InputStream is = this.getResources().openRawResource(R.raw.questions_thisorthat);
